...
import com.example.manish.echo.database.EchoDatabase
import com.example.manish.echo.fragments.SongPlayingFragment.Statified.myActivity
import java.util.*
...
class SongPlayingFragment : Fragment() {
    ...
    object Staticated {
        ...
        fun playNext(check: String) {
            if (check.equals("PlayNextNormal", true)) {
                ...
                var randomPostion = randomObject.nextInt(Statified.fetchSongs?.size?.plus(1) as Int)
                Statified.currentPosition = randomPostion
            }
    ...
    /* var updateSongTime = object : Runnable {
         override fun run() {
             ...
             Statified.startTimeText?.setText(String.format("%d:%d", TimeUnit.MILLISECONDS.toMinutes(getcurrent?.toLong() as Long),
                     TimeUnit.MILLISECONDS.toSeconds(getcurrent?.toLong() as Long) -
                             TimeUnit.MILLISECONDS.toSeconds(TimeUnit.MILLISECONDS.toMinutes(getcurrent?.toLong() as Long))))
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            Statified.currentSongHelper?.currentPostion = Statified.currentPosition
            Staticated.updateTextView(Statified.currentSongHelper?.songTitle as String,
        ...
        var favoriteBottomBar = arguments.get("FavBottomBar") as? String
